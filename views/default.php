...
<body>
	...
	<div class="container">
		...
		<ul class="nav navbar-nav">
		    <li <?php if (Lib\App::getRouter()->getController() == 'pagina') { ?>class="active"<?php } ?>><a href="<?= Lib\App::getRouter()->getUrl('home') ?>">Paginas</a></li>
		    <li <?php if (Lib\App::getRouter()->getController() == 'contato') { ?>class="active"<?php } ?>><a href="<?= Lib\App::getRouter()->getUrl('home') ?>">Contato</a></li>
		</ul>
	    </div><!--/.nav-collapse -->
	</div>
    </nav>
	...
	<script src="<?= Lib\App::getRouter()->getResourceUrl('static/js/default.js') ?>"></script>
</body>
</html>
